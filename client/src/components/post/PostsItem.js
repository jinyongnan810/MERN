...
const PostsItem = ({ post: { _id, text, name, avatar, user, likes, comments, date }, auth, addLike, removeLike, deletePost, showActions }) => {
    return (
...
export default connect(mapStateToProps, { addLike, removeLike, deletePost })(PostsItem)
